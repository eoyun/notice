...
int main(int argc, char *argv[])
{
  ...
  sprintf(mkdir_data_folder_wave,"/Users/drc_daq/scratch/202208TB/SSD/SSD_Run_%lu/Run_%lu_Wave/Run_%lu_Wave_log/",run_number,run_number,run_number);
  sprintf(mkdir_data_folder_fast,"/Users/drc_daq/scratch/202208TB/SSD/SSD_Run_%lu/Run_%lu_Fast/Run_%lu_Fast_log/",run_number,run_number,run_number);
  if((access(mkdir_data_folder_wave,0))!=0) {
    mkdir_data_folder_wave[0]='\0';
    sprintf(mkdir_data_folder_wave,"mkdir -p /Users/drc_daq/scratch/202208TB/SSD/SSD_Run_%lu/Run_%lu_Wave/Run_%lu_Wave_log/",run_number,run_number,run_number);
    system(mkdir_data_folder_wave);
  } else printf("directory exist!!\n");
  
  if((access(mkdir_data_folder_fast,0))!=0) {
    mkdir_data_folder_fast[0]='\0';
    sprintf(mkdir_data_folder_fast,"mkdir -p /Users/drc_daq/scratch/202208TB/SSD/SSD_Run_%lu/Run_%lu_Fast/Run_%lu_Fast_log/",run_number,run_number,run_number);
    system(mkdir_data_folder_fast);
  } else printf("directory exist!!\n");
  ...
  sprintf(wave_log_name, "/Users/drc_daq/scratch/202208TB/SSD/SSD_Run_%lu/Run_%lu_Wave/Run_%lu_Wave_log/Run_%lu_Wave_MID_%d_buffer.txt",run_number,run_number,run_number,run_number,mid);
  sprintf(fast_log_name, "/Users/drc_daq/scratch/202208TB/SSD/SSD_Run_%lu/Run_%lu_Fast/Run_%lu_Fast_log/Run_%lu_Fast_MID_%d_buffer.txt",run_number,run_number,run_number,run_number,mid);
  //evt flag name
