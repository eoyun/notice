...
if [ -f "$FILE" ]; then
    ...
    do
       ...
       root -l -q -b plot_spectrum_32ch_update.C'("./data/cal_wave_'$mid'_'$fname'.dat", '$rmin_', '$rmax_' )'; 
       root -b -q -l plot_waveform_32ch_AvgTimeStr.C'("./data/cal_wave_'$mid'_'$fname'.dat", '$rmin', '$rmax')';
       root -b -q -l plot_stddev_32ch.C'("./data/cal_wave_'$mid'_'$fname'.dat")'; 
       root -l -q -b plot_waveform_32ch.C'("./data/cal_wave_'$mid'_'$fname'.dat", '$rmin_', '$rmax_' )'; 
    done
