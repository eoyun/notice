...
void sync_study(const char* filename) {
    ...
    TH1F* plot3 = new TH1F("ch3", "#font[42]{#scale[0.8]{Module B - #color[634]{S ch}}};ADC;evts", 256, 0., 4095.); plot3->SetStats(0);
    plot3->SetLineWidth(2); plot3->SetLineColor(634); plot3->Sumw2();
    TH1F* plot5 = new TH1F("ch5", "#font[42]{#scale[0.8]{Module B - #color[602]{C ch}}};ADC;evts", 256, 0., 4095.); plot5->SetStats(0);
    plot5->SetLineWidth(2); plot5->SetLineColor(602); plot5->Sumw2();
    TH1F* plot7 = new TH1F("ch7", "#font[42]{#scale[0.8]{Module C - #color[634]{S ch}}};ADC;evts", 256, 0., 4095.); plot7->SetStats(0);
    plot7->SetLineWidth(2); plot7->SetLineColor(634); plot7->Sumw2();

    // TH1F* plot_wav_1 = new TH1F("plot1", "Waveform", 1000, 1, 1000);
    TH1F* plot_wav_1 = new TH1F("plot1", "Waveform", 1023, 0, 1023);
    ...
    for (int evt = 0; evt < nevt; evt++) {
        ...
        std::cout << evt << " " << plot_wav_1->GetMaximum() << std::endl;
...
// 18번 클리어, /media/yu/Expansion/DAQ_data/cal_1500_external_muon.dat
