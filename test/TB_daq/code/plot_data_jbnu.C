...
void plot_data_jbnu(const int runnum, const int Mid)
{
  char filename[100];
  FILE *fp;
  int file_size;
  ...
  int evt; 
  // filename here
  sprintf(filename,"/Users/yhep/scratch/YUdaq/Run_%d/Run_%d_Anc/Run_%d_Anc_MID_%d/Run_%d_Anc_MID_%d_FILE_0.dat",runnum,runnum,runnum,Mid,runnum,Mid);
