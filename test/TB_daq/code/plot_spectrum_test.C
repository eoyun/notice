...
//int plot_spectrum_32ch_update(const TString filename, const int min, const int max)
int plot_test(const int runnum, const int Mid, const int min, const int max)
{
  int channel;
  int ch_to_plot;
  FILE *fp;
