...
int intADC_2D(const int runnum, const int Mid, const int channel, const int min, const int max, const double time)
{
  int ch_to_plot;
  FILE *fp;
  FILE *fp2;
  ...
  TH2F *intADCHist = new TH2F("IntADC", "IntADC;Int.ADC;Evts", 1000, -1000., 100000., 1000, 0., 3000.);
