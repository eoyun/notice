...
int show_wave_intADC_cut(const int runnum, const int Mid, const int channel, const int min, const int max, const int intmin, const int intmax)
{
  //int channel;
  int ch_to_plot;
  FILE *fp;
