...
int show_wave_specific_over(const int runnum, const int Mid, const int channel1, const int channel2, const int min, const int max, const int peakThres, const int trigPattern)
{ 
  //int channel;
  int ch_to_plot;
  FILE *fp;
