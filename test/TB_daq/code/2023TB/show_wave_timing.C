...
int show_wave_timing(const int runnum, const int Mid1,const int Mid2, const int channel1,const int channel2,const int risetime, const int pulsewidth, const double fraction)
{
  //int channel;
  int ch_to_plot1;
  int ch_to_plot2;
  ...
  TH1F *plot1 = new TH1F("wave_plot1", ";1 bin = 12.5 ps; entry", 1000,0,16000); 
  TH1F *plot2 = new TH1F("wave_plot2", ";1 bin = 12.5 ps; entry", 1000,0,16000); 
  TH1F *plot_diff = new TH1F("diff", "difference;1 bin = 12.5 ps; entry", 1000,-16000, 16000); 
  plot1->SetStats(0);
  plot2->SetStats(0);
...
*/    
    ...
    //if(min_index>100 && min_index<150)
    double ped = 0.;
    ...
    if(min_index<100|| min_index>350) continue;
    ped = 0.;
    for (i=min_index-risetime-pulsewidth;i<min_index;i++){
      if(i<min_index-risetime){
